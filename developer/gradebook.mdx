---
title: "Multi-Item Gradebook Model in mod_exelearning"
...
**Completion by status** (`completionstatusrequired`, DEC-0052) is a custom completion rule that marks the activity complete when the user's attempt reaches a required status:
