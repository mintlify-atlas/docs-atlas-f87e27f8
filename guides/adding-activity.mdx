---
title: "Add an eXeLearning Resource to Your Moodle Course"
sidebarTitle: "Adding Activity"
description: "Step-by-step guide for teachers to add, configure, and publish an eXeLearning resource activity in a Moodle course."
---
...
|---|---|---|
| **Graded?** (`gradeenabled`) | On | Master grading switch. When turned off, the activity creates no gradebook columns, no attempt records, and behaves like a plain resource. All other grade and attempt fields are disabled while this is unchecked. |
...
| **Maximum grade per item** (`grademax`) | `100` | The maximum score each gradebook column can reach. Applied to every per-iDevice column and the overall column alike. |
