---
title: "mod_exelearning_save_track – Submit Tracking Data"
sidebarTitle: "Save Track"
description: "Submits per-iDevice scores for the current user via the shared track::ingest() pipeline. scoreraw is nullable; omitting it is a status-only no-op."
---
