...
sidebarTitle: "Access Info"
description: "Returns one can<cap> boolean per plugin capability for the calling user. No capability gate by design — a vector of false flags is the correct answer."
---
