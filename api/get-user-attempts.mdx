---
title: "mod_exelearning_get_user_attempts"
sidebarTitle: "get_user_attempts"
description: "Read function returning a user's attempt history on a mod_exelearning activity. Own attempts require :view; another user's attempts require :viewreport."
---
